...
Random Forest has the highest F-1 score for class 0 when run on the evaluation dataset, so it is being used for the unlabeled dataset. See report for full comparison between classifiers.
